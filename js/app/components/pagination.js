...
export const pagination = (() => {
     ...
     * @returns {void}
     */
    const disablePrevious = () => liPrev && !liPrev.classList.contains('disabled') ? liPrev.classList.add('disabled') : null;

    /**
     * @returns {void}
     */
    const enablePrevious = () => liPrev && liPrev.classList.contains('disabled') ? liPrev.classList.remove('disabled') : null;

    /**
     * @returns {void}
     */
    const disableNext = () => liNext && !liNext.classList.contains('disabled') ? liNext.classList.add('disabled') : null;

    /**
     * @returns {void}
     */
    const enableNext = () => liNext && liNext.classList.contains('disabled') ? liNext.classList.remove('disabled') : null;
    ...
    const init = () => {
        ...
        if (!paginate) {
            // Pagination element doesn't exist (comment section removed)
            return;
        }
